...
<table width="750" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td width="600" valign="top"><!-- InstanceBeginEditable name="content" --> 
      <span class="PageName"> !! -- SetPackage.jsp</span>
	  <form method="post" action="WebBaseMain.do" name="AdOrderData"> 
        ...
        <table width="400" border="0" align="center" cellpadding="0" cellspacing="0" class="navborder"> 
          <tr> 
            <td width="200%" colspan="4" class="heading">Choose A Package </td> 
          </tr> 
           
          <tr align="center"> 
            <td colspan="4"><webbase:orderData dataType="PackageSelector" editMode="1" numColumns="1"  packageButtonImageSrc="../../../images/apply.gif" nextURL="/jsp/SetMerchandiseAttributes.jsp" /></td> 
          </tr> 
          <tr> 
            <td colspan="4"><br /></td>
          </tr> 
