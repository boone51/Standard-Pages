...
<webbase:errorData dataType='ErrorURL' nextURL='/jsp/OrderConfirmation.jsp'/>
		<table width="400" border="0" align="center" cellpadding="0" cellspacing="0" class="navborder">
          <tr> 
            <td class="heading">Order Confirmation</td>
          </tr>
          <tr> 
            <td align="right">&nbsp;</td>
          </tr>
...
<tr>
                <td colspan="2"><span class="mgroupname">Enhance Your Online Ad</span></td>
              </tr>
<tr>
                <td colspan="2"><webbase:AdPay dataType="ClickNBuy" useHref="true" useNewWindow="true">Click here to enhance your online ad.</webbase:AdPay></td>
              </tr>
<tr>
                <td colspan="2">&nbsp;</td>
              </tr>
		...
		<webbase:showIf expression="isOnlinePhotoUploaded">
		  ...
		  <tr>
		    <td colspan="2" class="mgroupname"><webbase:uploadImage dataType="thumbNails" numColumns="2" thumbnailSize="100" displayOnly="true"/></td>
		  </tr>
		  <tr>
...
<%-- AdMission show uploaded images
<webbase:showIf expression="isOnlinePhotoUploaded">
  		  <tr>
                <td colspan="2">&nbsp;</td>
              </tr>
		  ...
		  <tr>
                <td colspan="2"><webbase:Ipix dataType="PreviewWebPhotos" heightDV="100" widthDV="100" modeDV="FitPad" numColumns="3"/></td>
              </tr>
</webbase:showIf> --%>
          ...
          <tr> 
            <td align="right" valign="top" width="88"><a href="WebBaseMain.do?cmd=LogOff&NextURL=/jsp/logout.jsp"><img src="../../../images/navigation/logoff.gif" width="54" height="17" BORDER=0></a></td>
